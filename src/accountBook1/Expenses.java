...
public class Expenses extends JFrame implements ItemListener, ActionListener {
	...
	public Expenses(int year, int month, int clickedDay, SessionManager sm) {
		...
		rbLabelArray = new String[] { "식비", "간식", "교통", "문화", "오락", "교육", "여행", "패션", "미용", "생필품", "통신", "주거비", "대출이자",
				"공과금", "적금", "편의점", "건강", "카페", "담배", "술", "취미", "용돈", "선물", "데이트", "기타" };
	...
	private void onConfirmButtonClicked() {
		...
		db.insertExpense(sm.getID(), sqlDateId, Integer.parseInt(expenseData[0]), expenseData[1], expenseData[2],
				expenseData[3]);
